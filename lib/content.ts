...
export const galleryImages = [
    {
        ...
        description: 'Ein Moment, an den ich immer wieder gerne zurückdenke.',
    },
    {
        src: '/photos/photo-2.jpg',
        alt: 'Gemeinsames Foto von euch',
        title: 'Ein Lieblingsbild',
        description: 'Weil manche Bilder einfach mehr sagen als viele Worte.',
    },
    {
        src: '/photos/photo-3.jpg',
        alt: 'Schöner gemeinsamer Augenblick',
        title: 'So viele Erinnerungen',
        description: 'Mit dir werden selbst kleine Momente zu etwas Besonderem.',
    },
    {
        src: '/photos/photo-4.jpg',
        alt: 'Schöner gemeinsamer Tag',
        title: 'Zusammen',
        description: 'Genau solche Augenblicke machen alles schöner.',
    },
    {
